...
$mod_strings = array (
  ...
  'LBL_NAME' => 'Όνομα',
  'LBL_REMOVE' => 'Αφαίρεση',
  'LBL_LIST_FORM_TITLE' => 'Event Fee Λίστα',
  'LBL_MODULE_NAME' => 'Event Fee',
  'LBL_MODULE_TITLE' => 'Event Fee',
  'LBL_MODULE_NAME_SINGULAR' => 'Event Fee',
  'LBL_HOMEPAGE_TITLE' => 'Δική Μου Event Fee',
  'LNK_NEW_RECORD' => 'Δημιουργία Event Fee',
  'LNK_LIST' => 'Προβολή Event Fee',
  'LNK_IMPORT_BHEA_EVENT_FEE' => 'Import Event Fee',
  'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Event Fee',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Δραστηριότητες',
  'LBL_BHEA_EVENT_FEE_SUBPANEL_TITLE' => 'Event Fee',
  'LBL_NEW_FORM_TITLE' => 'Νέα Event Fee',
  'LNK_IMPORT_VCARD' => 'Import Event Fee vCard',
  'LBL_IMPORT' => 'Import Event Fee',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new Event Fee record by importing a vCard from your file system.',
);