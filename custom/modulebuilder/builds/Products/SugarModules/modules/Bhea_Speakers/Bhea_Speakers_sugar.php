 ...
 * PLACE ANY CUSTOMIZATIONS IN Bhea_Speakers
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Bhea_Speakers_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Bhea_Speakers';
	var $object_name = 'Bhea_Speakers';
	var $table_name = 'bhea_speakers';
