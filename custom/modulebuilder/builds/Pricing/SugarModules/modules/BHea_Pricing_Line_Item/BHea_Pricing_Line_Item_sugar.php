 ...
 * PLACE ANY CUSTOMIZATIONS IN BHea_Pricing_Line_Item
 */

require_once('include/SugarObjects/templates/company/Company.php');

class BHea_Pricing_Line_Item_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'BHea_Pricing_Line_Item';
	var $object_name = 'BHea_Pricing_Line_Item';
	var $table_name = 'bhea_pricing_line_item';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
		...
		var $twitter;
		var $googleplus;
		var $bhea_pricing_line_item_type;
		var $industry;
		var $annual_revenue;
		var $phone_fax;
     ...
     * @depreciated
	 */
	function BHea_Pricing_Line_Item_sugar(){
		self::__construct();
	}
