 ...
 * PLACE ANY CUSTOMIZATIONS IN Bhea_Registrants
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Bhea_Registrants_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Bhea_Registrants';
	var $object_name = 'Bhea_Registrants';
	var $table_name = 'bhea_registrants';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
		...
		var $picture;
		var $status;
		var $bhea_account_plan_id_c;
		var $contact;
		var $bhea_account_plan_id1_c;
		var $account;
     ...
     * @depreciated
	 */
	function Bhea_Registrants_sugar(){
		self::__construct();
	}
