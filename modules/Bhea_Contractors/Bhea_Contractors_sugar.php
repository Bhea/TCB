 ...
 * PLACE ANY CUSTOMIZATIONS IN Bhea_Contractors
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Bhea_Contractors_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Bhea_Contractors';
	var $object_name = 'Bhea_Contractors';
	var $table_name = 'bhea_contractors';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
		...
		var $company_address_state;
		var $company_address_postalcode;
		var $company_address_country;
		var $company_address;
     ...
     * @depreciated
	 */
	function Bhea_Contractors_sugar(){
		self::__construct();
	}
