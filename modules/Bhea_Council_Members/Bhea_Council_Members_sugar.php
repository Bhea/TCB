 ...
 * PLACE ANY CUSTOMIZATIONS IN Bhea_Council_Members
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Bhea_Council_Members_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Bhea_Council_Members';
	var $object_name = 'Bhea_Council_Members';
	var $table_name = 'bhea_council_members';
     ...
     * @depreciated
	 */
	function Bhea_Council_Members_sugar(){
		self::__construct();
	}
